 ...
 */
var numeral = __webpack_require__(9);
var _ = __webpack_require__(3);
var RandExp = __webpack_require__(10);

var TPNumber = function () {
  _createClass(TPNumber, [{
    key: 'name',
    value: function name() {
      return 'number';
    }
  ...
  _createClass(TPNumber, [{
    ...
    value: function random() {
      ...
      var randomValue = (this._max - this._min) * Math.random() + this._min;
      if (this._format) {
...
var TPString = function () {
  _createClass(TPString, [{
    key: 'name',
    value: function name() {
      return 'string';
    }
  ...
  function TPString(preDefRegExpKey) {
    _classCallCheck(this, TPString);
  ...
  _createClass(TPString, [{
    ...
    key: 'range',
    value: function range(minLength, maxLength) {
...
TPString.preDefRegExpMap = {
  date: new RegExp(/(19|20)\d\d([-])(0[1-9]|1[012])\2(0[1-9]|[12][0-9]|3[01])/)
};

var TPBoolean = function () {
  function TPBoolean() {
    _classCallCheck(this, TPBoolean);
  }

  _createClass(TPBoolean, [{
    key: 'name',
    value: function name() {
      return 'boolean';
    }
...
var TPEnum = function () {
  ...
  function TPEnum(enumVals) {
    _classCallCheck(this, TPEnum);
  ...
  _createClass(TPEnum, [{
    key: 'random',
    value: function random() {
      var index = parseInt(Math.random() * this._enumVals.length);
...
exports.default = {
  boolean: function boolean() {
    return new TPBoolean();
  },
  number: function number() {
    return new TPNumber();
  },
  string: function string(preDefRegKey) {
    return new TPString(preDefRegKey);
  },
  enum: function _enum(array) {
    return new TPEnum(array);
  }
};
...
var Mocker = function () {
  ...
  _createClass(Mocker, null, [{
    key: 'mockObject',
    value: function mockObject(objConfig) {
      var result = {};
      for (var key in objConfig) {
        var valueType = objConfig[key];
        if (!valueType) {
    ...
    key: 'mockValue',
    value: function mockValue(valueType) {
    ...
    key: '_isValidType',
    value: function _isValidType(valueType) {
      if (!valueType || !_.isFunction(valueType.name)) {
        return false;
      }
      return [_Types2.default.string().name(), _Types2.default.boolean().name(), _Types2.default.number().name(), _Types2.default.string().name(), _Types2.default.enum([]).name()].indexOf(valueType.name()) !== -1;
    }
  }]);
...
function gen(token, groups) {
  ...
  switch (token.type) {
    ...
    case types.CHAR:
      var code = this.ignoreCase && randBool.call(this) ? toOtherCase(token.value) : token.value;
...
var types = __webpack_require__(0);
var sets = __webpack_require__(4);
...
exports.Types = exports.Mocker = undefined;

var _Mocker = __webpack_require__(5);
...
exports.Mocker = _Mocker2.default;
